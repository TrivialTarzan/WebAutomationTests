...
The project involved creating automated test scripts for three websites: greenkart.com, olx.pl and saucedemo.com, using Gherkin, Cucumber, Selenium, and JUnit. My primary goal of this project was to improve proficiency in writing test scripts.
